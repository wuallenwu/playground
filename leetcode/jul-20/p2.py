...
class Solution(object):
    def doesAliceWin(self, s):
        ...
        vowels = "aeiou"
        # examine substrings
        # at each step, alice must be able to remove vowels such that there's an odd amount remaining
        # if there's an even amount remaining, alice loses
        # if there's an odd amount remaining, bob loses
        # check if vowel in string
